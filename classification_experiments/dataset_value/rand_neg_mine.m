...
for iter = 1 : num_iter
    ...
    rand_neg_feat = zeros(nneg, size(pos_feat,2));
    start = 1;
    while start < nneg
        % Sample a set
        ...
        % Sample at most 10 examples per set
        this_num = randi(10, 1);
